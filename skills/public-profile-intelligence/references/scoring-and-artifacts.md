...
- PDF: use the full canonical report, usually 2 pages plus optional comparison page.
- PNG: prioritize the scorecard. Create additional images only when requested or when the environment supports a coherent multi-image set.
